...
extension SwaggerClientAPI {
    ...
    public class PrivateAPI: APIBase {
  ...
  "status" : "aeiou"
         ...
         */
        public class func createnewschedule(deviceId deviceId: String, moduleId: String, thermProgram: NAThermProgram) -> RequestBuilder<NANewScheduleResponse> {
            let path = "/createnewschedule"
  ...
  "status" : "aeiou"
         ...
         */
        public class func devicelist(appType appType: String?, deviceId: String?, getFavorites: Bool?) -> RequestBuilder<NADeviceListResponse> {
            let path = "/devicelist"
            let URLString = SwaggerClientAPI.basePath + path
  ...
  "status" : "aeiou"
         ...
         */
        public class func getmeasure(deviceId deviceId: String, scale: String, type: String, moduleId: String?, dateBegin: Int?, dateEnd: Int?, limit: Int?, optimize: Bool?, realTime: Bool?) -> RequestBuilder<NAMeasureResponse> {
            let path = "/getmeasure"
            let URLString = SwaggerClientAPI.basePath + path
  ...
  "status" : "aeiou"
         ...
         */
        public class func getthermstate(deviceId deviceId: String, moduleId: String) -> RequestBuilder<NAThermStateResponse> {
            let path = "/getthermstate"
            let URLString = SwaggerClientAPI.basePath + path
  ...
  "status" : "aeiou"
         ...
         */
        public class func getuser() -> RequestBuilder<NAUserResponse> {
            let path = "/getuser"
            let URLString = SwaggerClientAPI.basePath + path
  ...
  "status" : "aeiou"
         ...
         */
        public class func setthermpoint(deviceId deviceId: String, moduleId: String, setpointMode: String, setpointEndtime: Int?, setpointTemp: Float?) -> RequestBuilder<NAOkResponse> {
            let path = "/setthermpoint"
            let URLString = SwaggerClientAPI.basePath + path
  ...
  "status" : "aeiou"
         ...
         - returns: RequestBuilder<NAOkResponse> 
         */
        public class func switchschedule(deviceId deviceId: String, moduleId: String, scheduleId: String) -> RequestBuilder<NAOkResponse> {
            let path = "/switchschedule"
            let URLString = SwaggerClientAPI.basePath + path
  ...
  "status" : "aeiou"
         ...
         - returns: RequestBuilder<NAOkResponse> 
         */
        public class func syncschedule(deviceId deviceId: String, moduleId: String, thermProgram: NAThermProgram) -> RequestBuilder<NAOkResponse> {
            let path = "/syncschedule"
            let URLString = SwaggerClientAPI.basePath + path
