...
extension SwaggerClientAPI {
    ...
    public class PartnerAPI: APIBase {
        ...
        /**
         ...
         - GET /api/partnerdevices
         - The method partnerdevices returns the list of device_id to which your partner application has access to.
         - examples: [{contentType=application/json, example=""}]
         
         - parameter accessToken: (query) Your access token

         - returns: RequestBuilder<NAPartnerDevicesResponse> 
         */
        public class func partnerdevices(accessToken accessToken: String) -> RequestBuilder<NAPartnerDevicesResponse> {
            let path = "/api/partnerdevices"
            let URLString = SwaggerClientAPI.basePath + path
            ...
            let requestBuilder: RequestBuilder<NAPartnerDevicesResponse>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
