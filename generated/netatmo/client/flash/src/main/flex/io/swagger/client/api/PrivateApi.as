...
public class PrivateApi extends SwaggerApi {
    /**
    * Constructor for the PrivateApi api client
    * @param apiCredentials Wrapper object for tokens and hostName required towards authentication
    * @param eventDispatcher Optional event dispatcher that when provided is used by the SDK to dispatch any Response
    */
    public function PrivateApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
     ...
     */
    public function createnewschedule (deviceId: String, moduleId: String, thermProgram: NAThermProgram): String {
        // create path and map variables
        var path: String = "/createnewschedule".replace(/{format}/g,"xml");
     ...
     */
    public function devicelist (appType: String, deviceId: String, getFavorites: Boolean): String {
        // create path and map variables
        var path: String = "/devicelist".replace(/{format}/g,"xml");
     ...
     */
    public function getmeasure (deviceId: String, scale: String, type: String, moduleId: String, dateBegin: Number, dateEnd: Number, limit: Number, optimize: Boolean, realTime: Boolean): String {
        // create path and map variables
        var path: String = "/getmeasure".replace(/{format}/g,"xml");
     ...
     */
    public function getthermstate (deviceId: String, moduleId: String): String {
        // create path and map variables
        var path: String = "/getthermstate".replace(/{format}/g,"xml");
    ...
    public function getuser (): String {
        // create path and map variables
        var path: String = "/getuser".replace(/{format}/g,"xml");
     ...
     */
    public function setthermpoint (deviceId: String, moduleId: String, setpointMode: String, setpointEndtime: Number, setpointTemp: Number): String {
        // create path and map variables
        var path: String = "/setthermpoint".replace(/{format}/g,"xml");
     ...
     * Returns NAOkResponse 
     */
    public function switchschedule (deviceId: String, moduleId: String, scheduleId: String): String {
        // create path and map variables
        var path: String = "/switchschedule".replace(/{format}/g,"xml");
     ...
     * Returns NAOkResponse 
     */
    public function syncschedule (deviceId: String, moduleId: String, thermProgram: NAThermProgram): String {
        // create path and map variables
        var path: String = "/syncschedule".replace(/{format}/g,"xml");
