...
class PrivateApi(object):
    ...
    def createnewschedule(self, device_id, module_id, therm_program, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.createnewschedule(device_id, module_id, therm_program, callback=callback_function)
        ...
        if device_id is None:
            raise ValueError("Missing the required parameter `device_id` when calling `createnewschedule`")
        # verify the required parameter 'module_id' is set
        if module_id is None:
            raise ValueError("Missing the required parameter `module_id` when calling `createnewschedule`")
        # verify the required parameter 'therm_program' is set
        if therm_program is None:
            raise ValueError("Missing the required parameter `therm_program` when calling `createnewschedule`")

        all_params = ['device_id', 'module_id', 'therm_program']
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method createnewschedule" % key
                )
            params[key] = val
        del params['kwargs']

        resource_path = '/createnewschedule'.replace('{format}', 'json')
        method = 'POST'
        ...
        body_params = None
        if 'therm_program' in params:
            body_params = params['therm_program']
        ...
        auth_settings = ['code_oauth', 'password_oauth']
        ...
        response = self.api_client.call_api(resource_path, method,
                                            ...
                                            files=files,
                                            response_type='NANewScheduleResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def devicelist(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.devicelist(callback=callback_function)
        ...
        all_params = ['app_type', 'device_id', 'get_favorites']
        all_params.append('callback')
        ...
        resource_path = '/devicelist'.replace('{format}', 'json')
        method = 'GET'
    ...
    def getmeasure(self, device_id, scale, type, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.getmeasure(device_id, scale, type, callback=callback_function)
        ...
        all_params = ['device_id', 'scale', 'type', 'module_id', 'date_begin', 'date_end', 'limit', 'optimize', 'real_time']
        all_params.append('callback')
        ...
        resource_path = '/getmeasure'.replace('{format}', 'json')
        method = 'GET'
    ...
    def getthermstate(self, device_id, module_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.getthermstate(device_id, module_id, callback=callback_function)
        ...
        all_params = ['device_id', 'module_id']
        all_params.append('callback')
        ...
        resource_path = '/getthermstate'.replace('{format}', 'json')
        method = 'GET'
    ...
    def getuser(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.getuser(callback=callback_function)
        ...
        resource_path = '/getuser'.replace('{format}', 'json')
        method = 'GET'
        ...
        response = self.api_client.call_api(resource_path, method,
                                            ...
                                            post_params=form_params,
                                            files=files,
                                            response_type='NAUserResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def setthermpoint(self, device_id, module_id, setpoint_mode, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.setthermpoint(device_id, module_id, setpoint_mode, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str device_id: The relay id (required)
        :param str module_id: The thermostat id (required)
        :param str setpoint_mode: Chosen setpoint_mode (required)
        :param int setpoint_endtime: When using the manual or max setpoint_mode, this parameter defines when the setpoint expires.
        :param float setpoint_temp: When using the manual setpoint_mode, this parameter defines the temperature setpoint (in Celcius) to use.
        :return: NAOkResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        # verify the required parameter 'device_id' is set
        if device_id is None:
            raise ValueError("Missing the required parameter `device_id` when calling `setthermpoint`")
        # verify the required parameter 'module_id' is set
        if module_id is None:
            raise ValueError("Missing the required parameter `module_id` when calling `setthermpoint`")
        # verify the required parameter 'setpoint_mode' is set
        if setpoint_mode is None:
            raise ValueError("Missing the required parameter `setpoint_mode` when calling `setthermpoint`")

        all_params = ['device_id', 'module_id', 'setpoint_mode', 'setpoint_endtime', 'setpoint_temp']
        all_params.append('callback')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method setthermpoint" % key
                )
            params[key] = val
        del params['kwargs']

        resource_path = '/setthermpoint'.replace('{format}', 'json')
        method = 'POST'
        ...
        if 'module_id' in params:
            query_params['module_id'] = params['module_id']
        if 'setpoint_mode' in params:
            query_params['setpoint_mode'] = params['setpoint_mode']
        if 'setpoint_endtime' in params:
            query_params['setpoint_endtime'] = params['setpoint_endtime']
        if 'setpoint_temp' in params:
            query_params['setpoint_temp'] = params['setpoint_temp']
        ...
        response = self.api_client.call_api(resource_path, method,
                                            ...
                                            post_params=form_params,
                                            files=files,
                                            response_type='NAOkResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def switchschedule(self, device_id, module_id, schedule_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.switchschedule(device_id, module_id, schedule_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str device_id: The relay id (required)
        :param str module_id: The thermostat id (required)
        :param str schedule_id: The schedule id. It can be found in the getthermstate response, under the keys \"therm_program_backup\" and \"therm_program\". (required)
        :return: NAOkResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        # verify the required parameter 'device_id' is set
        if device_id is None:
            raise ValueError("Missing the required parameter `device_id` when calling `switchschedule`")
        # verify the required parameter 'module_id' is set
        if module_id is None:
            raise ValueError("Missing the required parameter `module_id` when calling `switchschedule`")
        # verify the required parameter 'schedule_id' is set
        if schedule_id is None:
            raise ValueError("Missing the required parameter `schedule_id` when calling `switchschedule`")

        all_params = ['device_id', 'module_id', 'schedule_id']
        all_params.append('callback')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method switchschedule" % key
                )
            params[key] = val
        del params['kwargs']

        resource_path = '/switchschedule'.replace('{format}', 'json')
        method = 'POST'
        ...
        if 'schedule_id' in params:
            query_params['schedule_id'] = params['schedule_id']
    ...
    def syncschedule(self, device_id, module_id, therm_program, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.syncschedule(device_id, module_id, therm_program, callback=callback_function)
        ...
        # verify the required parameter 'device_id' is set
        if device_id is None:
            raise ValueError("Missing the required parameter `device_id` when calling `syncschedule`")
        # verify the required parameter 'module_id' is set
        if module_id is None:
            raise ValueError("Missing the required parameter `module_id` when calling `syncschedule`")
        # verify the required parameter 'therm_program' is set
        if therm_program is None:
            raise ValueError("Missing the required parameter `therm_program` when calling `syncschedule`")
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method syncschedule" % key
                )
            params[key] = val
        del params['kwargs']

        resource_path = '/syncschedule'.replace('{format}', 'json')
        method = 'POST'
