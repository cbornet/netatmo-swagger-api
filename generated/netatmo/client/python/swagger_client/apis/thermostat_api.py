...
class ThermostatApi(object):
    ...
    def createnewschedule(self, access_token, device_id, module_id, therm_program, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.createnewschedule(access_token, device_id, module_id, therm_program, callback=callback_function)
        ...
        if access_token is None:
            raise ValueError("Missing the required parameter `access_token` when calling `createnewschedule`")
        ...
        all_params = ['access_token', 'device_id', 'module_id', 'therm_program']
        ...
        resource_path = '/api/createnewschedule'.replace('{format}', 'json')
        method = 'POST'
    ...
    def getuser(self, access_token, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.getuser(access_token, callback=callback_function)
        ...
        # verify the required parameter 'access_token' is set
        if access_token is None:
            raise ValueError("Missing the required parameter `access_token` when calling `getuser`")
        ...
        resource_path = '/api/getuser'.replace('{format}', 'json')
        method = 'GET'
    ...
    def setthermpoint(self, access_token, device_id, module_id, setpoint_mode, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.setthermpoint(access_token, device_id, module_id, setpoint_mode, callback=callback_function)
        ...
        # verify the required parameter 'access_token' is set
        if access_token is None:
            raise ValueError("Missing the required parameter `access_token` when calling `setthermpoint`")
        # verify the required parameter 'device_id' is set
        if device_id is None:
        ...
        all_params = ['access_token', 'device_id', 'module_id', 'setpoint_mode', 'setpoint_endtime', 'setpoint_temp']
        all_params.append('callback')
        ...
        resource_path = '/api/setthermpoint'.replace('{format}', 'json')
        method = 'POST'
    ...
    def switchschedule(self, access_token, device_id, module_id, schedule_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.switchschedule(access_token, device_id, module_id, schedule_id, callback=callback_function)
        ...
        # verify the required parameter 'access_token' is set
        if access_token is None:
            raise ValueError("Missing the required parameter `access_token` when calling `switchschedule`")
        # verify the required parameter 'device_id' is set
        if device_id is None:
        ...
        all_params = ['access_token', 'device_id', 'module_id', 'schedule_id']
        all_params.append('callback')
        ...
        resource_path = '/api/switchschedule'.replace('{format}', 'json')
        method = 'POST'
    ...
    def syncschedule(self, access_token, device_id, module_id, therm_program, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.syncschedule(access_token, device_id, module_id, therm_program, callback=callback_function)
        ...
        # verify the required parameter 'access_token' is set
        if access_token is None:
            raise ValueError("Missing the required parameter `access_token` when calling `syncschedule`")
        # verify the required parameter 'device_id' is set
        if device_id is None:
        ...
        resource_path = '/api/syncschedule'.replace('{format}', 'json')
        method = 'POST'
