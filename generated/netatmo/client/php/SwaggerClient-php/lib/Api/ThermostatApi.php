...
/**
 * ThermostatApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class ThermostatApi
{
     ...
     */
    public function createnewschedule($access_token, $device_id, $module_id, $therm_program)
    {
        
        // verify the required parameter 'access_token' is set
        if ($access_token === null) {
            throw new \InvalidArgumentException('Missing the required parameter $access_token when calling createnewschedule');
        }
        ...
        // parse inputs
        $resourcePath = "/api/createnewschedule";
        ...
        try
        {
            ...
            return $this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\NANewScheduleResponse', $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\NANewScheduleResponse', $e->getResponseHeaders());
    ...
    public function getuser($access_token)
    {
        ...
        try
        {
            ...
            return $this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\NAUserResponse', $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\NAUserResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function setthermpoint($access_token, $device_id, $module_id, $setpoint_mode, $setpoint_endtime=null, $setpoint_temp=null)
    {
        
        // verify the required parameter 'access_token' is set
        if ($access_token === null) {
            throw new \InvalidArgumentException('Missing the required parameter $access_token when calling setthermpoint');
        }
        // verify the required parameter 'device_id' is set
        if ($device_id === null) {
        ...
        // parse inputs
        $resourcePath = "/api/setthermpoint";
        $resourcePath = str_replace("{format}", "json", $resourcePath);
        $method = "POST";
        $httpBody = '';
        $queryParams = array();
        ...
        try
        {
            ...
            return $this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\NAOkResponse', $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\NAOkResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function switchschedule($access_token, $device_id, $module_id, $schedule_id)
    {
        
        // verify the required parameter 'access_token' is set
        if ($access_token === null) {
            throw new \InvalidArgumentException('Missing the required parameter $access_token when calling switchschedule');
        }
        // verify the required parameter 'device_id' is set
        if ($device_id === null) {
        ...
        // parse inputs
        $resourcePath = "/api/switchschedule";
        $resourcePath = str_replace("{format}", "json", $resourcePath);
        $method = "POST";
        $httpBody = '';
        $queryParams = array();
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function syncschedule($access_token, $device_id, $module_id, $therm_program)
    {
        
        // verify the required parameter 'access_token' is set
        if ($access_token === null) {
            throw new \InvalidArgumentException('Missing the required parameter $access_token when calling syncschedule');
        }
        // verify the required parameter 'device_id' is set
        if ($device_id === null) {
