...
SamiWelcomeApi::devicelistWithCompletion(String* accessToken, String* appType, String* deviceId, Boolean* getFavorites, void (* success)(SamiNADeviceListResponse*, SamiError*)) {
  ...
  client->execute(SamiWelcomeApi::getBasePath(), url, "GET", (IMap*)queryParams, mBody, (IMap*)headerParams, null, L"application/json");
  return null;
}
...
SamiWelcomeApi::getmeasureWithCompletion(String* accessToken, String* deviceId, String* scale, IList* type, String* moduleId, Integer* dateBegin, Integer* dateEnd, Integer* limit, Boolean* optimize, Boolean* realTime, void (* success)(SamiNAMeasureResponse*, SamiError*)) {
  client = new SamiApiClient();
...
SamiNAUserResponse* 
SamiWelcomeApi::getuserWithCompletion(String* accessToken, void (* success)(SamiNAUserResponse*, SamiError*)) {
  client = new SamiApiClient();
