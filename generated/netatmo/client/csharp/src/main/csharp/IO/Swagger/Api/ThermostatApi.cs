...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IThermostatApi
    {
        ...
        NANewScheduleResponse Createnewschedule (string accessToken, string deviceId, string moduleId, NAThermProgram thermProgram);
        ...
        /// <param name="thermProgram">The thermostat program (zones and timetable)</param>
        /// <returns>NANewScheduleResponse</returns>
        System.Threading.Tasks.Task<NANewScheduleResponse> CreatenewscheduleAsync (string accessToken, string deviceId, string moduleId, NAThermProgram thermProgram);
        ...
        NAThermStateResponse Getthermstate (string accessToken, string deviceId, string moduleId);
        ...
        /// <param name="moduleId">The thermostat id</param>
        /// <returns>NAThermStateResponse</returns>
        System.Threading.Tasks.Task<NAThermStateResponse> GetthermstateAsync (string accessToken, string deviceId, string moduleId);
        ...
        NAOkResponse Setthermpoint (string accessToken, string deviceId, string moduleId, string setpointMode, int? setpointEndtime, float? setpointTemp);
        ...
        /// <param name="setpointTemp">When using the manual setpoint_mode, this parameter defines the temperature setpoint (in Celcius) to use.</param>
        /// <returns>NAOkResponse</returns>
        System.Threading.Tasks.Task<NAOkResponse> SetthermpointAsync (string accessToken, string deviceId, string moduleId, string setpointMode, int? setpointEndtime, float? setpointTemp);
        ...
        /// <returns>NAOkResponse</returns>
        NAOkResponse Switchschedule (string accessToken, string deviceId, string moduleId, string scheduleId);
        ...
        /// <param name="scheduleId">The schedule id. It can be found in the getthermstate response, under the keys \&quot;therm_program_backup\&quot; and \&quot;therm_program\&quot;.</param>
        /// <returns>NAOkResponse</returns>
        System.Threading.Tasks.Task<NAOkResponse> SwitchscheduleAsync (string accessToken, string deviceId, string moduleId, string scheduleId);
        ...
        /// <returns>NAOkResponse</returns>
        NAOkResponse Syncschedule (string accessToken, string deviceId, string moduleId, NAThermProgram thermProgram);
        ...
        /// <param name="thermProgram">The thermostat program (zones, timetable and name)</param>
        /// <returns>NAOkResponse</returns>
        System.Threading.Tasks.Task<NAOkResponse> SyncscheduleAsync (string accessToken, string deviceId, string moduleId, NAThermProgram thermProgram);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class ThermostatApi : IThermostatApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ThermostatApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public ThermostatApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ThermostatApi(String basePath)
        {
        ...
        /// <param name="thermProgram">The thermostat program (zones and timetable)</param> 
        /// <returns>NANewScheduleResponse</returns>            
        public NANewScheduleResponse Createnewschedule (string accessToken, string deviceId, string moduleId, NAThermProgram thermProgram)
        {
        ...
        /// <param name="moduleId">The thermostat id</param> 
        /// <returns>NAThermStateResponse</returns>            
        public NAThermStateResponse Getthermstate (string accessToken, string deviceId, string moduleId)
        {
            
            // verify the required parameter 'accessToken' is set
            if (accessToken == null) throw new ApiException(400, "Missing required parameter 'accessToken' when calling Getthermstate");
        ...
        /// <param name="moduleId">The thermostat id</param>
        /// <returns>NAThermStateResponse</returns>
        public async System.Threading.Tasks.Task<NAThermStateResponse> GetthermstateAsync (string accessToken, string deviceId, string moduleId)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null) throw new ApiException(400, "Missing required parameter 'accessToken' when calling Getthermstate");
            // verify the required parameter 'deviceId' is set
        ...
        /// <param name="setpointTemp">When using the manual setpoint_mode, this parameter defines the temperature setpoint (in Celcius) to use.</param> 
        /// <returns>NAOkResponse</returns>            
        public NAOkResponse Setthermpoint (string accessToken, string deviceId, string moduleId, string setpointMode, int? setpointEndtime, float? setpointTemp)
        {
            
            // verify the required parameter 'accessToken' is set
            if (accessToken == null) throw new ApiException(400, "Missing required parameter 'accessToken' when calling Setthermpoint");
        ...
        /// <param name="setpointTemp">When using the manual setpoint_mode, this parameter defines the temperature setpoint (in Celcius) to use.</param>
        /// <returns>NAOkResponse</returns>
        public async System.Threading.Tasks.Task<NAOkResponse> SetthermpointAsync (string accessToken, string deviceId, string moduleId, string setpointMode, int? setpointEndtime, float? setpointTemp)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null) throw new ApiException(400, "Missing required parameter 'accessToken' when calling Setthermpoint");
            // verify the required parameter 'deviceId' is set
        ...
        /// <param name="scheduleId">The schedule id. It can be found in the getthermstate response, under the keys \&quot;therm_program_backup\&quot; and \&quot;therm_program\&quot;.</param> 
        /// <returns>NAOkResponse</returns>            
        public NAOkResponse Switchschedule (string accessToken, string deviceId, string moduleId, string scheduleId)
        {
            
            // verify the required parameter 'accessToken' is set
            if (accessToken == null) throw new ApiException(400, "Missing required parameter 'accessToken' when calling Switchschedule");
        ...
        /// <param name="scheduleId">The schedule id. It can be found in the getthermstate response, under the keys \&quot;therm_program_backup\&quot; and \&quot;therm_program\&quot;.</param>
        /// <returns>NAOkResponse</returns>
        public async System.Threading.Tasks.Task<NAOkResponse> SwitchscheduleAsync (string accessToken, string deviceId, string moduleId, string scheduleId)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null) throw new ApiException(400, "Missing required parameter 'accessToken' when calling Switchschedule");
            // verify the required parameter 'deviceId' is set
        ...
        /// <param name="thermProgram">The thermostat program (zones, timetable and name)</param> 
        /// <returns>NAOkResponse</returns>            
        public NAOkResponse Syncschedule (string accessToken, string deviceId, string moduleId, NAThermProgram thermProgram)
        {
            
            // verify the required parameter 'accessToken' is set
            if (accessToken == null) throw new ApiException(400, "Missing required parameter 'accessToken' when calling Syncschedule");
        ...
        /// <param name="thermProgram">The thermostat program (zones, timetable and name)</param>
        /// <returns>NAOkResponse</returns>
        public async System.Threading.Tasks.Task<NAOkResponse> SyncscheduleAsync (string accessToken, string deviceId, string moduleId, NAThermProgram thermProgram)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null) throw new ApiException(400, "Missing required parameter 'accessToken' when calling Syncschedule");
            // verify the required parameter 'deviceId' is set
