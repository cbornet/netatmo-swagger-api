...
namespace IO.Swagger.Api
{
    ...
    public interface IPartnerApi
    {
        ...
        /// </remarks>
        /// <param name="accessToken">Your access token</param>
        /// <returns>NAPartnerDevicesResponse</returns>
        NAPartnerDevicesResponse Partnerdevices (string accessToken);
        ...
        /// <param name="accessToken">Your access token</param>
        /// <returns>NAPartnerDevicesResponse</returns>
        System.Threading.Tasks.Task<NAPartnerDevicesResponse> PartnerdevicesAsync (string accessToken);
    ...
    public class PartnerApi : IPartnerApi
    {
        ...
        /// <param name="accessToken">Your access token</param> 
        /// <returns>NAPartnerDevicesResponse</returns>            
        public NAPartnerDevicesResponse Partnerdevices (string accessToken)
        {
            
            // verify the required parameter 'accessToken' is set
            if (accessToken == null) throw new ApiException(400, "Missing required parameter 'accessToken' when calling Partnerdevices");
            
    
            var path = "/api/partnerdevices";
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling Partnerdevices: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling Partnerdevices: " + response.ErrorMessage, response.ErrorMessage);
    
            return (NAPartnerDevicesResponse) ApiClient.Deserialize(response.Content, typeof(NAPartnerDevicesResponse), response.Headers);
        }
        ...
        /// <param name="accessToken">Your access token</param>
        /// <returns>NAPartnerDevicesResponse</returns>
        public async System.Threading.Tasks.Task<NAPartnerDevicesResponse> PartnerdevicesAsync (string accessToken)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null) throw new ApiException(400, "Missing required parameter 'accessToken' when calling Partnerdevices");
