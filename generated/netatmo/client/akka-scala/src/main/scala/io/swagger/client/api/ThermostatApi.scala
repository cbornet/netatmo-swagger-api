...
object ThermostatApi {
   ...
   */
  def createnewschedule(accessToken: String, deviceId: String, moduleId: String, thermProgram: NAThermProgram): ApiRequest[NANewScheduleResponse] =
   ...
   * @param accessToken Your access token
   */
  def getuser(accessToken: String): ApiRequest[NAUserResponse] =
   ...
   */
  def setthermpoint(accessToken: String, deviceId: String, moduleId: String, setpointMode: String, setpointEndtime: Option[Int] = None, setpointTemp: Option[Float] = None): ApiRequest[NAOkResponse] =
   ...
   */
  def switchschedule(accessToken: String, deviceId: String, moduleId: String, scheduleId: String): ApiRequest[NAOkResponse] =
   ...
   */
  def syncschedule(accessToken: String, deviceId: String, moduleId: String, thermProgram: NAThermProgram): ApiRequest[NAOkResponse] =
