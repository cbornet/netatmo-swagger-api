...
class ThermostatApi(val defBasePath: String = "https://api.netatmo.net/",
   ...
   */
  def createnewschedule (accessToken: String, deviceId: String, moduleId: String, thermProgram: NAThermProgram) : Option[NANewScheduleResponse] = {
    // create path and map variables
    val path = "/api/createnewschedule".replaceAll("\\{format\\}","json")
   ...
   */
  def devicelist (accessToken: String, appType: String, deviceId: String, getFavorites: Boolean) : Option[NADeviceListResponse] = {
    // create path and map variables
    val path = "/api/devicelist".replaceAll("\\{format\\}","json")
   ...
   */
  def getthermstate (accessToken: String, deviceId: String, moduleId: String) : Option[NAThermStateResponse] = {
    // create path and map variables
    val path = "/api/getthermstate".replaceAll("\\{format\\}","json")
   ...
   */
  def getuser (accessToken: String) : Option[NAUserResponse] = {
    // create path and map variables
    val path = "/api/getuser".replaceAll("\\{format\\}","json")
   ...
   * @return NAOkResponse
   */
  def setthermpoint (accessToken: String, deviceId: String, moduleId: String, setpointMode: String, setpointEndtime: Integer, setpointTemp: Float) : Option[NAOkResponse] = {
    // create path and map variables
    val path = "/api/setthermpoint".replaceAll("\\{format\\}","json")
   ...
   * @return NAOkResponse
   */
  def switchschedule (accessToken: String, deviceId: String, moduleId: String, scheduleId: String) : Option[NAOkResponse] = {
    // create path and map variables
    val path = "/api/switchschedule".replaceAll("\\{format\\}","json")
   ...
   * @return NAOkResponse
   */
  def syncschedule (accessToken: String, deviceId: String, moduleId: String, thermProgram: NAThermProgram) : Option[NAOkResponse] = {
    // create path and map variables
    val path = "/api/syncschedule".replaceAll("\\{format\\}","json")
