...
class PartnerApi {
  ...
  PartnerApi([ApiClient apiClient]) {
    if (apiClient != null) {
  ...
  Future<NAPartnerDevicesResponse> partnerdevices(String accessToken) {
    Object postBody = null;
    ...
    return apiClient.invokeAPI(basePath, path, 'GET', queryParams, postBody, headerParams, formParams, contentType, authNames).then((response) {
      if(response.statusCode >= 400) {
        ...
        return ApiClient.deserialize(response.body, NAPartnerDevicesResponse);
      }
      else {
        return null;
      }
