...
namespace Swagger {
SWGStationApi::SWGStationApi() {}

SWGStationApi::~SWGStationApi() {}

SWGStationApi::SWGStationApi(QString host, QString basePath) {
    this->host = host;
    this->basePath = basePath;
}

void
SWGStationApi::devicelist(QString* accessToken, QString* appType, QString* deviceId, bool getFavorites) {
    QString fullPath;
    ...
    connect(worker,
            ...
            this,
            &SWGStationApi::devicelistCallback);

    worker->execute(&input);
}

void
SWGStationApi::devicelistCallback(HttpRequestWorker * worker) {
    QString msg;
...
void
SWGStationApi::getmeasure(QString* accessToken, QString* deviceId, QString* scale, QList<QString*>* type, QString* moduleId, qint32 dateBegin, qint32 dateEnd, qint32 limit, bool optimize, bool realTime) {
    QString fullPath;
    ...
    connect(worker,
            &HttpRequestWorker::on_execution_finished,
            this,
            &SWGStationApi::getmeasureCallback);

    worker->execute(&input);
}

void
SWGStationApi::getmeasureCallback(HttpRequestWorker * worker) {
    QString msg;
    if (worker->error_type == QNetworkReply::NoError) {
        msg = QString("Success! %1 bytes").arg(worker->response.length());
    }
...
void
SWGStationApi::getuser(QString* accessToken) {
    QString fullPath;
    ...
    connect(worker,
            &HttpRequestWorker::on_execution_finished,
            this,
            &SWGStationApi::getuserCallback);

    worker->execute(&input);
}

void
SWGStationApi::getuserCallback(HttpRequestWorker * worker) {
    QString msg;
    if (worker->error_type == QNetworkReply::NoError) {
        msg = QString("Success! %1 bytes").arg(worker->response.length());
    }
