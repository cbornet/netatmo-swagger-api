...
public class PartnerApi {
  ...
  private Call partnerdevicesCall(String accessToken) throws ApiException {
    Object postBody = null;
    
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
       throw new ApiException("Missing the required parameter 'accessToken' when calling partnerdevices(Async)");
    }
  ...
  public NAPartnerDevicesResponse partnerdevices(String accessToken) throws ApiException {
    Call call = partnerdevicesCall(accessToken);
    Type returnType = new TypeToken<NAPartnerDevicesResponse>(){}.getType();
    return apiClient.execute(call, returnType);
  }
   ...
   * @return The request call
   */
  public Call partnerdevicesAsync(String accessToken, ApiCallback<NAPartnerDevicesResponse> callback) throws ApiException {
    Call call = partnerdevicesCall(accessToken);
    Type returnType = new TypeToken<NAPartnerDevicesResponse>(){}.getType();
    apiClient.executeAsync(call, returnType, callback);
    return call;
