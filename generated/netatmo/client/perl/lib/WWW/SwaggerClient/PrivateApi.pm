...
#
package WWW::SwaggerClient::PrivateApi;
...
sub createnewschedule {
    ...
    # parse inputs
    my $_resource_path = '/createnewschedule';
    ...
    my $auth_settings = ['code_oauth', 'password_oauth'];
...
sub getthermstate {
    ...
    # parse inputs
    my $_resource_path = '/getthermstate';
    $_resource_path =~ s/{format}/json/; # default format to json
...
sub getuser {
    ...
    # authentication setting, if any
    my $auth_settings = ['password_oauth'];
...
sub setthermpoint {
    ...
    # parse inputs
    my $_resource_path = '/setthermpoint';
    $_resource_path =~ s/{format}/json/; # default format to json
...
sub switchschedule {
    ...
    # parse inputs
    my $_resource_path = '/switchschedule';
    $_resource_path =~ s/{format}/json/; # default format to json
...
sub syncschedule {
    ...
    # parse inputs
    my $_resource_path = '/syncschedule';
    $_resource_path =~ s/{format}/json/; # default format to json
