...
public class ThermostatApi {
  ...
  public NANewScheduleResponse  createnewschedule (String accessToken, String deviceId, String moduleId, NAThermProgram thermProgram) throws ApiException {
    ...
    if (accessToken == null) {
       throw new ApiException(400, "Missing the required parameter 'accessToken' when calling createnewschedule");
    }
    ...
    queryParams.addAll(ApiInvoker.parameterToPairs("", "module_id", moduleId));
    ...
    try {
      ...
      if(response != null){
        return (NANewScheduleResponse) ApiInvoker.deserialize(response, "", NANewScheduleResponse.class);
      }
      else {
        return null;
      }
  ...
  public NADeviceListResponse  devicelist (String accessToken, String appType, String deviceId, Boolean getFavorites) throws ApiException {
    ...
    queryParams.addAll(ApiInvoker.parameterToPairs("", "app_type", appType));
    
    queryParams.addAll(ApiInvoker.parameterToPairs("", "device_id", deviceId));
    
    queryParams.addAll(ApiInvoker.parameterToPairs("", "get_favorites", getFavorites));
    ...
    try {
      ...
      if(response != null){
        return (NADeviceListResponse) ApiInvoker.deserialize(response, "", NADeviceListResponse.class);
      }
      else {
        return null;
      }
  ...
  public NAMeasureResponse  getmeasure (String accessToken, String deviceId, String scale, List<String> type, String moduleId, Integer dateBegin, Integer dateEnd, Integer limit, Boolean optimize, Boolean realTime) throws ApiException {
    ...
    queryParams.addAll(ApiInvoker.parameterToPairs("", "date_begin", dateBegin));
    
    queryParams.addAll(ApiInvoker.parameterToPairs("", "date_end", dateEnd));
    
    queryParams.addAll(ApiInvoker.parameterToPairs("", "limit", limit));
    
    queryParams.addAll(ApiInvoker.parameterToPairs("", "optimize", optimize));
    
    queryParams.addAll(ApiInvoker.parameterToPairs("", "real_time", realTime));
    ...
    try {
      String response = apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType);
      if(response != null){
        return (NAMeasureResponse) ApiInvoker.deserialize(response, "", NAMeasureResponse.class);
      }
      else {
        return null;
      }
  ...
  public NAThermStateResponse  getthermstate (String accessToken, String deviceId, String moduleId) throws ApiException {
    ...
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
       throw new ApiException(400, "Missing the required parameter 'accessToken' when calling getthermstate");
    }
    ...
    try {
      String response = apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType);
      if(response != null){
        return (NAThermStateResponse) ApiInvoker.deserialize(response, "", NAThermStateResponse.class);
      }
      else {
        return null;
      }
  ...
  public NAUserResponse  getuser (String accessToken) throws ApiException {
    ...
    try {
      String response = apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType);
      if(response != null){
        return (NAUserResponse) ApiInvoker.deserialize(response, "", NAUserResponse.class);
      }
      else {
        return null;
      }
  ...
  public NAOkResponse  setthermpoint (String accessToken, String deviceId, String moduleId, String setpointMode, Integer setpointEndtime, Float setpointTemp) throws ApiException {
    ...
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
       throw new ApiException(400, "Missing the required parameter 'accessToken' when calling setthermpoint");
    }
    ...
    queryParams.addAll(ApiInvoker.parameterToPairs("", "setpoint_mode", setpointMode));
    
    queryParams.addAll(ApiInvoker.parameterToPairs("", "setpoint_endtime", setpointEndtime));
    
    queryParams.addAll(ApiInvoker.parameterToPairs("", "setpoint_temp", setpointTemp));
    ...
    try {
      String response = apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType);
      if(response != null){
        return (NAOkResponse) ApiInvoker.deserialize(response, "", NAOkResponse.class);
      }
      else {
        return null;
      }
  ...
  public NAOkResponse  switchschedule (String accessToken, String deviceId, String moduleId, String scheduleId) throws ApiException {
    ...
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
       throw new ApiException(400, "Missing the required parameter 'accessToken' when calling switchschedule");
    }
    ...
    queryParams.addAll(ApiInvoker.parameterToPairs("", "schedule_id", scheduleId));
  ...
  public NAOkResponse  syncschedule (String accessToken, String deviceId, String moduleId, NAThermProgram thermProgram) throws ApiException {
    ...
    // verify the required parameter 'accessToken' is set
    if (accessToken == null) {
       throw new ApiException(400, "Missing the required parameter 'accessToken' when calling syncschedule");
    }
