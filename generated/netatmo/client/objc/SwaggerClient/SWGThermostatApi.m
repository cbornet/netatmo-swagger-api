...
@interface SWGThermostatApi ()
    @property (readwrite, nonatomic, strong) NSMutableDictionary *defaultHeaders;
@end

@implementation SWGThermostatApi

static SWGThermostatApi* singletonAPI = nil;
...
+(SWGThermostatApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {

    if (singletonAPI == nil) {
        singletonAPI = [[SWGThermostatApi alloc] init];
        [singletonAPI addHeader:headerValue forKey:key];
    }
    return singletonAPI;
}

+(SWGThermostatApi*) sharedAPI {
...
///
-(NSNumber*) createnewscheduleWithCompletionBlock: (NSString*) accessToken
    ...
    if (accessToken == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `accessToken` when calling `createnewschedule`"];
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/createnewschedule"];
...
///
-(NSNumber*) getthermstateWithCompletionBlock: (NSString*) accessToken
         deviceId: (NSString*) deviceId
         moduleId: (NSString*) moduleId
    ...
    // verify the required parameter 'accessToken' is set
    if (accessToken == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `accessToken` when calling `getthermstate`"];
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/getthermstate"];
...
///
-(NSNumber*) setthermpointWithCompletionBlock: (NSString*) accessToken
         deviceId: (NSString*) deviceId
         moduleId: (NSString*) moduleId
    ...
    // verify the required parameter 'accessToken' is set
    if (accessToken == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `accessToken` when calling `setthermpoint`"];
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/setthermpoint"];
...
///  @returns SWGNAOkResponse*
///
-(NSNumber*) switchscheduleWithCompletionBlock: (NSString*) accessToken
         deviceId: (NSString*) deviceId
         moduleId: (NSString*) moduleId
    ...
    // verify the required parameter 'accessToken' is set
    if (accessToken == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `accessToken` when calling `switchschedule`"];
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/switchschedule"];
...
///  @returns SWGNAOkResponse*
///
-(NSNumber*) syncscheduleWithCompletionBlock: (NSString*) accessToken
         deviceId: (NSString*) deviceId
         moduleId: (NSString*) moduleId
         thermProgram: (SWGNAThermProgram*) thermProgram
    ...
    // verify the required parameter 'accessToken' is set
    if (accessToken == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `accessToken` when calling `syncschedule`"];
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/syncschedule"];
