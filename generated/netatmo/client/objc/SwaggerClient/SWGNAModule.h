...
@protocol SWGNAModule
@end

@interface SWGNAModule : SWGObject
...
/* It contains all the measurements that can be displayed on the dashboard [optional]
 */
@property(nonatomic) SWGNADashboardData* dashboardData;
