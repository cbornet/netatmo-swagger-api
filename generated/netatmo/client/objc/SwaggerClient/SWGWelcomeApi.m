...
@interface SWGWelcomeApi ()
    @property (readwrite, nonatomic, strong) NSMutableDictionary *defaultHeaders;
@end

@implementation SWGWelcomeApi

static SWGWelcomeApi* singletonAPI = nil;
...
+(SWGWelcomeApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {

    if (singletonAPI == nil) {
        singletonAPI = [[SWGWelcomeApi alloc] init];
        [singletonAPI addHeader:headerValue forKey:key];
    }
    return singletonAPI;
}

+(SWGWelcomeApi*) sharedAPI {
