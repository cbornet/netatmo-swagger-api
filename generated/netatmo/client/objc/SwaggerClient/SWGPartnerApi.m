#import "SWGPartnerApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGNADeviceListResponse.h"
#import "SWGNAMeasureResponse.h"
#import "SWGNAThermStateResponse.h"
#import "SWGNAPartnerDevicesResponse.h"


@interface SWGPartnerApi ()
    @property (readwrite, nonatomic, strong) NSMutableDictionary *defaultHeaders;
@end

@implementation SWGPartnerApi

static SWGPartnerApi* singletonAPI = nil;
...
+(SWGPartnerApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {

    if (singletonAPI == nil) {
        singletonAPI = [[SWGPartnerApi alloc] init];
        [singletonAPI addHeader:headerValue forKey:key];
    }
    return singletonAPI;
}

+(SWGPartnerApi*) sharedAPI {
...
///  @param accessToken Your access token
///
///  @returns SWGNAPartnerDevicesResponse*
///
-(NSNumber*) partnerdevicesWithCompletionBlock: (NSString*) accessToken
        
        completionHandler: (void (^)(SWGNAPartnerDevicesResponse* output, NSError* error))completionBlock { 
        

    
    // verify the required parameter 'accessToken' is set
    if (accessToken == nil) {
        [NSException raise:@"Invalid parameter" format:@"Missing the required parameter `accessToken` when calling `partnerdevices`"];
    }
    

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/partnerdevices"];
    ...
    return [self.apiClient requestWithCompletionBlock: resourcePath
                                   ...
                                   requestContentType: requestContentType
                                  responseContentType: responseContentType
                                         responseType: @"SWGNAPartnerDevicesResponse*"
                                      completionBlock: ^(id data, NSError *error) {
                  
                  completionBlock((SWGNAPartnerDevicesResponse*)data, error);
              }
          ];
}
