  ...
  class WelcomeApi
    ...
    def devicelist(access_token, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: WelcomeApi#devicelist ..."
      end
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: WelcomeApi#devicelist. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def getmeasure(access_token, device_id, scale, type, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: WelcomeApi#getmeasure ..."
      end
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: WelcomeApi#getmeasure. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def getuser(access_token, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: WelcomeApi#getuser ..."
      end
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: WelcomeApi#getuser. Result: #{result.inspect}"
      end
      return result
    end
  end
