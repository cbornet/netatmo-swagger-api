  ...
  class StationApi
    ...
    def devicelist(access_token, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: StationApi#devicelist ..."
      end
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: StationApi#devicelist. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def getmeasure(access_token, device_id, scale, type, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: StationApi#getmeasure ..."
      end
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: StationApi#getmeasure. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def getuser(access_token, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: StationApi#getuser ..."
      end
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: StationApi#getuser. Result: #{result.inspect}"
      end
      return result
    end
  end
