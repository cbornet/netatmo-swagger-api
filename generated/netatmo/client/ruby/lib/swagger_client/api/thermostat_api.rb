...
module SwaggerClient
  class ThermostatApi
    ...
    def createnewschedule(access_token, device_id, module_id, therm_program, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: ThermostatApi#createnewschedule ..."
      end
      
      # verify the required parameter 'access_token' is set
      fail "Missing the required parameter 'access_token' when calling createnewschedule" if access_token.nil?
      ...
      # resource path
      path = "/api/createnewschedule".sub('{format}','json')
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: ThermostatApi#createnewschedule. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def devicelist(access_token, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: ThermostatApi#devicelist ..."
      end
      
      # verify the required parameter 'access_token' is set
      fail "Missing the required parameter 'access_token' when calling devicelist" if access_token.nil?
      ...
      # resource path
      path = "/api/devicelist".sub('{format}','json')
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: ThermostatApi#devicelist. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def getmeasure(access_token, device_id, scale, type, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: ThermostatApi#getmeasure ..."
      end
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: ThermostatApi#getmeasure. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def getthermstate(access_token, device_id, module_id, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: ThermostatApi#getthermstate ..."
      end
      
      # verify the required parameter 'access_token' is set
      fail "Missing the required parameter 'access_token' when calling getthermstate" if access_token.nil?
      ...
      # resource path
      path = "/api/getthermstate".sub('{format}','json')
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: ThermostatApi#getthermstate. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def getuser(access_token, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: ThermostatApi#getuser ..."
      end
      
      # verify the required parameter 'access_token' is set
      fail "Missing the required parameter 'access_token' when calling getuser" if access_token.nil?
      
      # resource path
      path = "/api/getuser".sub('{format}','json')
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: ThermostatApi#getuser. Result: #{result.inspect}"
      end
      return result
    end
    ...
    # @return [NAOkResponse]
    def setthermpoint(access_token, device_id, module_id, setpoint_mode, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: ThermostatApi#setthermpoint ..."
      end
      
      # verify the required parameter 'access_token' is set
      fail "Missing the required parameter 'access_token' when calling setthermpoint" if access_token.nil?
      ...
      # resource path
      path = "/api/setthermpoint".sub('{format}','json')
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: ThermostatApi#setthermpoint. Result: #{result.inspect}"
      end
      return result
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [NAOkResponse]
    def switchschedule(access_token, device_id, module_id, schedule_id, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: ThermostatApi#switchschedule ..."
      end
      
      # verify the required parameter 'access_token' is set
      fail "Missing the required parameter 'access_token' when calling switchschedule" if access_token.nil?
      ...
      # resource path
      path = "/api/switchschedule".sub('{format}','json')
      ...
      result = @api_client.call_api(:POST, path,
        ...
        :return_type => 'NAOkResponse')
      if Configuration.debugging
        Configuration.logger.debug "API called: ThermostatApi#switchschedule. Result: #{result.inspect}"
      end
      return result
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [NAOkResponse]
    def syncschedule(access_token, device_id, module_id, therm_program, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: ThermostatApi#syncschedule ..."
      end
      
      # verify the required parameter 'access_token' is set
      fail "Missing the required parameter 'access_token' when calling syncschedule" if access_token.nil?
      ...
      # resource path
      path = "/api/syncschedule".sub('{format}','json')
      ...
      result = @api_client.call_api(:POST, path,
        ...
        :return_type => 'NAOkResponse')
      if Configuration.debugging
        Configuration.logger.debug "API called: ThermostatApi#syncschedule. Result: #{result.inspect}"
      end
      return result
    end
  end
