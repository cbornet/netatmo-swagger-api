  ...
  class PartnerApi
    ...
    def devicelist(access_token, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: PartnerApi#devicelist ..."
      end
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: PartnerApi#devicelist. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def getmeasure(access_token, device_id, scale, type, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: PartnerApi#getmeasure ..."
      end
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: PartnerApi#getmeasure. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def getthermstate(access_token, device_id, module_id, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: PartnerApi#getthermstate ..."
      end
      ...
      if Configuration.debugging
        Configuration.logger.debug "API called: PartnerApi#getthermstate. Result: #{result.inspect}"
      end
      return result
    end
    ...
    def partnerdevices(access_token, opts = {})
      if Configuration.debugging
        Configuration.logger.debug "Calling API: PartnerApi#partnerdevices ..."
      end
      
      # verify the required parameter 'access_token' is set
      fail "Missing the required parameter 'access_token' when calling partnerdevices" if access_token.nil?
      
      # resource path
      path = "/api/partnerdevices".sub('{format}','json')
      ...
      result = @api_client.call_api(:GET, path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'NAPartnerDevicesResponse')
      if Configuration.debugging
        Configuration.logger.debug "API called: PartnerApi#partnerdevices. Result: #{result.inspect}"
      end
      return result
    end
  end
