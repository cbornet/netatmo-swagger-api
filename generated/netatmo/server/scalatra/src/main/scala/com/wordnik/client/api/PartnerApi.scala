...
import com.wordnik.client.model.NAPartnerDevicesResponse
...
class PartnerApi (implicit val swagger: Swagger) extends ScalatraServlet 
    with FileUploadSupport
    with JacksonJsonSupport
    with SwaggerSupport {
  protected implicit val jsonFormats: Formats = DefaultFormats

  protected val applicationDescription: String = "PartnerApi"
  override protected val applicationName: Option[String] = Some("Partner")
  ...
  val partnerdevicesOperation = (apiOperation[NAPartnerDevicesResponse]("partnerdevices")
      summary ""
      parameters(
        queryParam[String]("accessToken").description("")
  ...
  get("/api/partnerdevices",operation(partnerdevicesOperation)) {
