...
@Controller
@RequestMapping(value = "/partnerdevices", produces = {APPLICATION_JSON_VALUE})
@Api(value = "/partnerdevices", description = "the partnerdevices API")
...
public class PartnerdevicesApi {
  ...
  public ResponseEntity<NAPartnerDevicesResponse> partnerdevices()
