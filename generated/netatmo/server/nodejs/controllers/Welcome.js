...
var Welcome = require('./WelcomeService');
...
module.exports.devicelist = function devicelist (req, res, next) {
  ...
  var result = Welcome.devicelist(accessToken, appType, deviceId, getFavorites);
...
module.exports.getmeasure = function getmeasure (req, res, next) {
  ...
  var result = Welcome.getmeasure(accessToken, deviceId, scale, type, moduleId, dateBegin, dateEnd, limit, optimize, realTime);
...
module.exports.getuser = function getuser (req, res, next) {
  ...
  var result = Welcome.getuser(accessToken);
